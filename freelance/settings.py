...
FRONTEND_URL = 'https://127.0.0.1:8000' #os.getenv('FRONTEND_URL')
BACKEND_URL =  'https://127.0.0.1:8000' # os.getenv('BACKEND_URL')
DOMAIN =   'https://127.0.0.1:8000' #os.getenv('DOMAIN')
